...
from utils import (
    get_neo4j_driver,
    format_value, # Assuming this is your updated version from utils.py
    calculate_delta,
    _arrow
)
...
def cash_flow_tab_content(selected_symbol_from_app):
    ...
    cf_metric_groups_config = [
        ...
        {"card_metric": "incomeTaxesPaid", "card_title": "Income Taxes Paid", "help": "Actual cash paid for income taxes"}, # Informational
    ]
